  ...
  <div class="col-4">
    <div class="card mb-3">
      ...
      <div class="card-body d-flex flex-column justify-content-center align-items-center">
        <h5 class="card-title text-center text-capitalize">{{ pokemonData ? pokemonData.name : pokemon.name }}</h5>
...
const getpokemonGender = () => {
  return pokemonData.value ? (pokemonData.value.gender ? pokemonData.value.gender.name : 'Desconhecido') : 'Desconhecido';
};
